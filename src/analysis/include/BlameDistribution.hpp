...
namespace casita
{
  ...
  /*    uint64_t waitStateTime;        //<! accumulated waiting time of the list members, end node waiting time is not
   * included */
      ...
      BlameReason                     reason = REASON_UNCLASSIFIED )
  {
        ...
        iter != walkList.end( ); ++iter )
    {
      ...
      else
      {
        ...
        /*                   strcmp( lastWalkNode->getName(), "!$omp implicit barrier @calculateTauMatrix.cpp:506" ) ==
         * 0, */
