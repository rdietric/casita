 ...
 */
OTF2ParallelTraceWriter::OTF2ParallelTraceWriter( AnalysisEngine* analysis, OTF2DefinitionHandler* defHandler )
  :
  analysis( analysis ),
 ...
 */
void
OTF2ParallelTraceWriter::writeEventsWithWaitingTime( OTF2Event event,
    ...
    bool                                                    graphNodesAvailable )
{
  ...
  if ( streamState.onCriticalPath == true ) {
  ...
  if ( mapsInternalNode )
  {
    ...
    else
    {
      ...
      if ( nextNode )
      {
        ...
        if ( currentNode->isOffloadKernel( ) &&
...
OTF2_CallbackCode
OTF2ParallelTraceWriter::otf2GlobalDefReaderCallback_MetricMember( void* userData,
...
OTF2_CallbackCode
OTF2ParallelTraceWriter::otf2GlobalDefReaderCallback_MetricClass( void* userData,
    OTF2_MetricRef                                                      self,
...
OTF2_CallbackCode
OTF2ParallelTraceWriter::otf2GlobalDefReaderCallback_MetricInstance( void* userData,
    OTF2_MetricRef                                                         self,
...
OTF2_CallbackCode
OTF2ParallelTraceWriter::otf2EvtCallbackThreadFork( OTF2_LocationRef locationID,
    OTF2_TimeStamp                                                   time,
    void*                                                            userData,
    OTF2_AttributeList*                                              attributeList,
    OTF2_Paradigm                                                    paradigm,
 ...
 */
OTF2_CallbackCode
OTF2ParallelTraceWriter::otf2CallbackMetric( OTF2_LocationRef location,
    OTF2_TimeStamp                                            time,
    void*                                                     userData,
    OTF2_AttributeList*                                       attributeList,
...
OTF2_CallbackCode
OTF2ParallelTraceWriter::otf2Callback_MpiIrecvRequest( OTF2_LocationRef locationID,
    OTF2_TimeStamp                                                      time,
    void*                                                               userData,
    OTF2_AttributeList*                                                 attributeList,
    uint64_t                                                            requestID )
...
OTF2_CallbackCode
OTF2ParallelTraceWriter::otf2Callback_MpiIsendComplete( OTF2_LocationRef locationID,
    OTF2_TimeStamp                                                       time,
    void*                                                                userData,
    OTF2_AttributeList*                                                  attributeList,
    uint64_t                                                             requestID )
